...
const unsigned char errorMainNoPressure =	error_base + 8;		// main pressure sensor value out of range
const unsigned char errorMainPressureInsane =	error_base + 9;		// main pressure sensor broken
